		...
		function VidyoClient(plugInDivId, onStatus)
		{
				...
				this.CreateCalendarInstance = function(feedback, pluginServiceId, calendarName, createToken) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('feedback') && arguments[0].hasOwnProperty('pluginServiceId') && arguments[0].hasOwnProperty('calendarName') && arguments[0].hasOwnProperty('createToken')){
							var params = VCUtils.jQuery.param({calMgr: this.objId, feedback: (arguments[0].feedback ? arguments[0].feedback.objId : 0), pluginServiceId: arguments[0].pluginServiceId, calendarName: arguments[0].calendarName, createToken: arguments[0].createToken});
						} else {
						...
						var params = VCUtils.jQuery.param({calMgr: this.objId, feedback: (arguments[0] ? arguments[0].objId : 0), pluginServiceId: arguments[1], calendarName: arguments[2], createToken: arguments[3]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.GetCalendarRegisteredServices = function(svcNames) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('svcNames')){
							var params = VCUtils.jQuery.param({cm: this.objId, svcNames: JSON.stringify({"svcNames": arguments[0].svcNames})});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['svcNames'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
						var params = VCUtils.jQuery.param({cm: this.objId, svcNames: JSON.stringify({"svcNames": arguments[0]})});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
						function OnComplete(response) {
							if(svcNames&& response.data.svcNames)
								VCUtils.jQuery.extend(svcNames, response.data.svcNames);
				...
				this.RegisterCalendarService = function(pluginServiceName, dllName) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('pluginServiceName') && arguments[0].hasOwnProperty('dllName')){
							var params = VCUtils.jQuery.param({cm: this.objId, pluginServiceName: arguments[0].pluginServiceName, dllName: arguments[0].dllName});
						} else {
						...
						var params = VCUtils.jQuery.param({cm: this.objId, pluginServiceName: arguments[0], dllName: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.CreateMeetingWithId = function(id, feedback, createToken) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('id') && arguments[0].hasOwnProperty('feedback') && arguments[0].hasOwnProperty('createToken')){
							var params = VCUtils.jQuery.param({c: this.objId, id: arguments[0].id, feedback: (arguments[0].feedback ? arguments[0].feedback.objId : 0), createToken: arguments[0].createToken});
						} else {
						...
						var params = VCUtils.jQuery.param({c: this.objId, id: arguments[0], feedback: (arguments[1] ? arguments[1].objId : 0), createToken: arguments[2]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.GetCapabilities = function(requestedCapabilities) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('requestedCapabilities')){
							var params = VCUtils.jQuery.param({c: this.objId, requestedCapabilities: JSON.stringify({"requestedCapabilities": arguments[0].requestedCapabilities})});
						} else {
						...
						var params = VCUtils.jQuery.param({c: this.objId, requestedCapabilities: JSON.stringify({"requestedCapabilities": arguments[0]})});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SearchMeetings = function(searchText, beginDateTime, endDateTime, index, pageSize) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('searchText') && arguments[0].hasOwnProperty('beginDateTime') && arguments[0].hasOwnProperty('endDateTime') && arguments[0].hasOwnProperty('index') && arguments[0].hasOwnProperty('pageSize')){
							var params = VCUtils.jQuery.param({c: this.objId, searchText: arguments[0].searchText, beginDateTime: arguments[0].beginDateTime, endDateTime: arguments[0].endDateTime, index: arguments[0].index, pageSize: arguments[0].pageSize});
						} else {
						...
						var params = VCUtils.jQuery.param({c: this.objId, searchText: arguments[0], beginDateTime: arguments[1], endDateTime: arguments[2], index: arguments[3], pageSize: arguments[4]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetSingleSignOn = function(setSingleSignOn) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('setSingleSignOn')){
							var params = VCUtils.jQuery.param({c: this.objId, setSingleSignOn: arguments[0].setSingleSignOn});
						} else {
						...
						var params = VCUtils.jQuery.param({c: this.objId, setSingleSignOn: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.AssignViewToLocalMonitor = function(viewId, localMonitor, displayCropped, allowZoom) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('localMonitor') && arguments[0].hasOwnProperty('displayCropped') && arguments[0].hasOwnProperty('allowZoom')){
							...
							var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0].viewId, localMonitor: (arguments[0].localMonitor ? arguments[0].localMonitor.objId : 0), displayCropped: arguments[0].displayCropped, allowZoom: arguments[0].allowZoom});
						} else {
						...
						var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0], localMonitor: (arguments[1] ? arguments[1].objId : 0), displayCropped: arguments[2], allowZoom: arguments[3]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
						function OnComplete(response) {
							if(localMonitor&& response.data.localMonitor)
								VCUtils.jQuery.extend(localMonitor, response.data.localMonitor);
							resolve(response.data);
						}
						function OnError(response) {
							reject(Error(response));
				...
				this.AssignViewToLocalWindowShare = function(viewId, localWindowShare, displayCropped, allowZoom) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('localWindowShare') && arguments[0].hasOwnProperty('displayCropped') && arguments[0].hasOwnProperty('allowZoom')){
							...
							var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0].viewId, localWindowShare: (arguments[0].localWindowShare ? arguments[0].localWindowShare.objId : 0), displayCropped: arguments[0].displayCropped, allowZoom: arguments[0].allowZoom});
						} else {
						...
						var params = VCUtils.jQuery.param({c: this.objId, viewId: arguments[0], localWindowShare: (arguments[1] ? arguments[1].objId : 0), displayCropped: arguments[2], allowZoom: arguments[3]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
						function OnComplete(response) {
							if(localWindowShare&& response.data.localWindowShare)
								VCUtils.jQuery.extend(localWindowShare, response.data.localWindowShare);
							resolve(response.data);
						}
						function OnError(response) {
							reject(Error(response));
				...
				this.ConnectToRoomAsGuest = function(host, displayName, roomKey, roomPin, onSuccess, onFailure, onDisconnected) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('host') && arguments[0].hasOwnProperty('displayName') && arguments[0].hasOwnProperty('roomKey') && arguments[0].hasOwnProperty('roomPin') && arguments[0].hasOwnProperty('onSuccess') && arguments[0].hasOwnProperty('onFailure') && arguments[0].hasOwnProperty('onDisconnected')){
							...
							this.VidyoConnectorOnFailure = arguments[0].onFailure;
							this.VidyoConnectorOnDisconnected = arguments[0].onDisconnected;
							var params = VCUtils.jQuery.param({c: this.objId, host: arguments[0].host, displayName: arguments[0].displayName, roomKey: arguments[0].roomKey, roomPin: arguments[0].roomPin});
						} else {
						...
						this.VidyoConnectorOnFailure = onFailure;
						this.VidyoConnectorOnDisconnected = onDisconnected;
						var params = VCUtils.jQuery.param({c: this.objId, host: arguments[0], displayName: arguments[1], roomKey: arguments[2], roomPin: arguments[3]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.ConnectToRoomWithId = function(host, userName, password, roomId, roomPin, onSuccess, onFailure, onDisconnected) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('host') && arguments[0].hasOwnProperty('userName') && arguments[0].hasOwnProperty('password') && arguments[0].hasOwnProperty('roomId') && arguments[0].hasOwnProperty('roomPin') && arguments[0].hasOwnProperty('onSuccess') && arguments[0].hasOwnProperty('onFailure') && arguments[0].hasOwnProperty('onDisconnected')){
							...
							this.VidyoConnectorOnFailure = arguments[0].onFailure;
							this.VidyoConnectorOnDisconnected = arguments[0].onDisconnected;
							var params = VCUtils.jQuery.param({c: this.objId, host: arguments[0].host, userName: arguments[0].userName, password: arguments[0].password, roomId: arguments[0].roomId, roomPin: arguments[0].roomPin});
						} else {
						...
						this.VidyoConnectorOnFailure = onFailure;
						this.VidyoConnectorOnDisconnected = onDisconnected;
						var params = VCUtils.jQuery.param({c: this.objId, host: arguments[0], userName: arguments[1], password: arguments[2], roomId: arguments[3], roomPin: arguments[4]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.ConnectToRoomWithKey = function(host, userName, password, roomKey, roomPin, onSuccess, onFailure, onDisconnected) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('host') && arguments[0].hasOwnProperty('userName') && arguments[0].hasOwnProperty('password') && arguments[0].hasOwnProperty('roomKey') && arguments[0].hasOwnProperty('roomPin') && arguments[0].hasOwnProperty('onSuccess') && arguments[0].hasOwnProperty('onFailure') && arguments[0].hasOwnProperty('onDisconnected')){
							...
							this.VidyoConnectorOnFailure = arguments[0].onFailure;
							this.VidyoConnectorOnDisconnected = arguments[0].onDisconnected;
							var params = VCUtils.jQuery.param({c: this.objId, host: arguments[0].host, userName: arguments[0].userName, password: arguments[0].password, roomKey: arguments[0].roomKey, roomPin: arguments[0].roomPin});
						} else {
						...
						this.VidyoConnectorOnFailure = onFailure;
						this.VidyoConnectorOnDisconnected = onDisconnected;
						var params = VCUtils.jQuery.param({c: this.objId, host: arguments[0], userName: arguments[1], password: arguments[2], roomKey: arguments[3], roomPin: arguments[4]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.ConnectToRoomWithTokenAndId = function(host, userName, token, roomId, roomPin, onSuccess, onFailure, onDisconnected) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('host') && arguments[0].hasOwnProperty('userName') && arguments[0].hasOwnProperty('token') && arguments[0].hasOwnProperty('roomId') && arguments[0].hasOwnProperty('roomPin') && arguments[0].hasOwnProperty('onSuccess') && arguments[0].hasOwnProperty('onFailure') && arguments[0].hasOwnProperty('onDisconnected')){
							...
							this.VidyoConnectorOnFailure = arguments[0].onFailure;
							this.VidyoConnectorOnDisconnected = arguments[0].onDisconnected;
							var params = VCUtils.jQuery.param({c: this.objId, host: arguments[0].host, userName: arguments[0].userName, token: arguments[0].token, roomId: arguments[0].roomId, roomPin: arguments[0].roomPin});
						} else {
						...
						this.VidyoConnectorOnFailure = onFailure;
						this.VidyoConnectorOnDisconnected = onDisconnected;
						var params = VCUtils.jQuery.param({c: this.objId, host: arguments[0], userName: arguments[1], token: arguments[2], roomId: arguments[3], roomPin: arguments[4]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.ConnectToRoomWithTokenAndKey = function(host, userName, token, roomKey, roomPin, onSuccess, onFailure, onDisconnected) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('host') && arguments[0].hasOwnProperty('userName') && arguments[0].hasOwnProperty('token') && arguments[0].hasOwnProperty('roomKey') && arguments[0].hasOwnProperty('roomPin') && arguments[0].hasOwnProperty('onSuccess') && arguments[0].hasOwnProperty('onFailure') && arguments[0].hasOwnProperty('onDisconnected')){
							...
							this.VidyoConnectorOnFailure = arguments[0].onFailure;
							this.VidyoConnectorOnDisconnected = arguments[0].onDisconnected;
							var params = VCUtils.jQuery.param({c: this.objId, host: arguments[0].host, userName: arguments[0].userName, token: arguments[0].token, roomKey: arguments[0].roomKey, roomPin: arguments[0].roomPin});
						} else {
						...
						this.VidyoConnectorOnFailure = onFailure;
						this.VidyoConnectorOnDisconnected = onDisconnected;
						var params = VCUtils.jQuery.param({c: this.objId, host: arguments[0], userName: arguments[1], token: arguments[2], roomKey: arguments[3], roomPin: arguments[4]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.ReportLocalParticipantOnJoined = function(reportLocalParticipant) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('reportLocalParticipant')){
							var params = VCUtils.jQuery.param({c: this.objId, reportLocalParticipant: arguments[0].reportLocalParticipant});
						} else {
						...
						var params = VCUtils.jQuery.param({c: this.objId, reportLocalParticipant: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SelectVirtualWindowShare = function(virtualWindowShare) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('virtualWindowShare')){
							var params = VCUtils.jQuery.param({c: this.objId, virtualWindowShare: (arguments[0].virtualWindowShare ? arguments[0].virtualWindowShare.objId : 0)});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['virtualWindowShare'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
						var params = VCUtils.jQuery.param({c: this.objId, virtualWindowShare: (arguments[0] ? arguments[0].objId : 0)});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetFontFileName = function(fontFileName) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('fontFileName')){
							var params = VCUtils.jQuery.param({c: this.objId, fontFileName: arguments[0].fontFileName});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['fontFileName'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "string")){
						var params = VCUtils.jQuery.param({c: this.objId, fontFileName: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetVoiceProcessing = function(voiceProcessing, mode) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('voiceProcessing') && arguments[0].hasOwnProperty('mode')){
							var params = VCUtils.jQuery.param({m: this.objId, voiceProcessing: arguments[0].voiceProcessing, mode: arguments[0].mode});
						} else {
						...
						var params = VCUtils.jQuery.param({m: this.objId, voiceProcessing: arguments[0], mode: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
			...
			this.VidyoLocalRenderer = function(){
				...
				this.EnableSelfViewCustomLayout = function(enable) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('enable')){
							var params = VCUtils.jQuery.param({renderer: this.objId, enable: arguments[0].enable});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['enable'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "boolean")){
						var params = VCUtils.jQuery.param({renderer: this.objId, enable: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.PinParticipant = function(p, pin) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('p') && arguments[0].hasOwnProperty('pin')){
							var params = VCUtils.jQuery.param({r: this.objId, p: (arguments[0].p ? arguments[0].p.objId : 0), pin: arguments[0].pin});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['p', 'pin'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 2 && (typeof(arguments[0]) === "object") && (typeof(arguments[1]) === "boolean")){
						var params = VCUtils.jQuery.param({r: this.objId, p: (arguments[0] ? arguments[0].objId : 0), pin: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetAllowContentMultiScreen = function(allow, displayIndex) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('allow') && arguments[0].hasOwnProperty('displayIndex')){
							var params = VCUtils.jQuery.param({r: this.objId, allow: arguments[0].allow, displayIndex: arguments[0].displayIndex});
						} else {
						...
						var params = VCUtils.jQuery.param({r: this.objId, allow: arguments[0], displayIndex: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetAnimationSpeed = function(speedPercentage) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('speedPercentage')){
							var params = VCUtils.jQuery.param({renderer: this.objId, speedPercentage: arguments[0].speedPercentage});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['speedPercentage'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "number")){
						var params = VCUtils.jQuery.param({renderer: this.objId, speedPercentage: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetBackgroundColor = function(red, green, blue) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('red') && arguments[0].hasOwnProperty('green') && arguments[0].hasOwnProperty('blue')){
							var params = VCUtils.jQuery.param({renderer: this.objId, red: arguments[0].red, green: arguments[0].green, blue: arguments[0].blue});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['red', 'green', 'blue'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 3 && (typeof(arguments[0]) === "number") && (typeof(arguments[1]) === "number") && (typeof(arguments[2]) === "number")){
						var params = VCUtils.jQuery.param({renderer: this.objId, red: arguments[0], green: arguments[1], blue: arguments[2]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetBorderStyle = function(style) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('style')){
							var params = VCUtils.jQuery.param({ct: this.objId, style: arguments[0].style});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['style'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "string")){
						var params = VCUtils.jQuery.param({ct: this.objId, style: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetCropped = function(cropped) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('cropped')){
							var params = VCUtils.jQuery.param({renderer: this.objId, cropped: arguments[0].cropped});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['cropped'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "boolean")){
						var params = VCUtils.jQuery.param({renderer: this.objId, cropped: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetMaxStreamsMultiScreen = function(numStreams, displayIndex) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('numStreams') && arguments[0].hasOwnProperty('displayIndex')){
							var params = VCUtils.jQuery.param({r: this.objId, numStreams: arguments[0].numStreams, displayIndex: arguments[0].displayIndex});
						} else {
						...
						var params = VCUtils.jQuery.param({r: this.objId, numStreams: arguments[0], displayIndex: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetParametersForHighDPIDevice = function(pixelsPerInch, viewingDistance, isTouchInputDevice) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('pixelsPerInch') && arguments[0].hasOwnProperty('viewingDistance') && arguments[0].hasOwnProperty('isTouchInputDevice')){
							var params = VCUtils.jQuery.param({r: this.objId, pixelsPerInch: arguments[0].pixelsPerInch, viewingDistance: arguments[0].viewingDistance, isTouchInputDevice: arguments[0].isTouchInputDevice});
						} else {
						...
						var params = VCUtils.jQuery.param({r: this.objId, pixelsPerInch: arguments[0], viewingDistance: arguments[1], isTouchInputDevice: arguments[2]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetPipPosition = function(x, y, lockPip) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('x') && arguments[0].hasOwnProperty('y') && arguments[0].hasOwnProperty('lockPip')){
							var params = VCUtils.jQuery.param({r: this.objId, x: arguments[0].x, y: arguments[0].y, lockPip: arguments[0].lockPip});
						} else {
						...
						var params = VCUtils.jQuery.param({r: this.objId, x: arguments[0], y: arguments[1], lockPip: arguments[2]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetPriorityMultiScreen = function(priority, displayIndex) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('priority') && arguments[0].hasOwnProperty('displayIndex')){
							var params = VCUtils.jQuery.param({r: this.objId, priority: arguments[0].priority, displayIndex: arguments[0].displayIndex});
						} else {
						...
						var params = VCUtils.jQuery.param({r: this.objId, priority: arguments[0], displayIndex: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetRemoteWindowSharePinMode = function(autoPin) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('autoPin')){
							var params = VCUtils.jQuery.param({r: this.objId, autoPin: arguments[0].autoPin});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['autoPin'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "boolean")){
						var params = VCUtils.jQuery.param({r: this.objId, autoPin: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.ShowAudioMeters = function(showMeters) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('showMeters')){
							var params = VCUtils.jQuery.param({renderer: this.objId, showMeters: arguments[0].showMeters});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['showMeters'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "boolean")){
						var params = VCUtils.jQuery.param({renderer: this.objId, showMeters: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.ShowDebugStats = function(showStats) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('showStats')){
							var params = VCUtils.jQuery.param({renderer: this.objId, showStats: arguments[0].showStats});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['showStats'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "boolean")){
						var params = VCUtils.jQuery.param({renderer: this.objId, showStats: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.ShowLabel = function(showLabel) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('showLabel')){
							var params = VCUtils.jQuery.param({renderer: this.objId, showLabel: arguments[0].showLabel});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['showLabel'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "boolean")){
						var params = VCUtils.jQuery.param({renderer: this.objId, showLabel: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
			...
			this.CreateVidyoVideoFrame = function(format, buffer, size, releaseCallback, width, height) {
				...
				if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
					if(arguments[0].hasOwnProperty('format') && arguments[0].hasOwnProperty('buffer') && arguments[0].hasOwnProperty('size') && arguments[0].hasOwnProperty('releaseCallback') && arguments[0].hasOwnProperty('width') && arguments[0].hasOwnProperty('height')){
						var params = VCUtils.jQuery.param({x: this.objId, format: arguments[0].format, buffer: arguments[0].buffer, size: arguments[0].size, width: arguments[0].width, height: arguments[0].height});
					} else {
					...
					var params = VCUtils.jQuery.param({x: this.objId, format: arguments[0], buffer: arguments[1], size: arguments[1], width: arguments[3], height: arguments[4]});
				} else {
					return Promise.reject(new Error('Invalid Parameters'));
				}
			...
			this.VidyoVideoFrame = function(format, buffer, size, releaseCallback, width, height) {
				if(arguments.length === 1 && arguments[0].objId && arguments[0].objType && arguments[0].objType === "VidyoVideoFrame"){
					...
					if(response == null)
						throw new Error('No Response from VidyoClient');
					VCUtils.jQuery.extend(this, response.VidyoVideoFrame);
					objects[this.objId] = this;
			...
			this.CreateVidyoVirtualWindowShare = function(id, windowName, applicationName, onStart, onReconfigure, onStop) {
				...
				if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
					if(arguments[0].hasOwnProperty('id') && arguments[0].hasOwnProperty('windowName') && arguments[0].hasOwnProperty('applicationName') && arguments[0].hasOwnProperty('onStart') && arguments[0].hasOwnProperty('onReconfigure') && arguments[0].hasOwnProperty('onStop')){
						var params = VCUtils.jQuery.param({w: this.objId, id: arguments[0].id, windowName: arguments[0].windowName, applicationName: arguments[0].applicationName});
					} else {
					...
					var params = VCUtils.jQuery.param({w: this.objId, id: arguments[0], windowName: arguments[1], applicationName: arguments[2]});
				} else {
					return Promise.reject(new Error('Invalid Parameters'));
				}
			...
			this.VidyoVirtualWindowShare = function(id, windowName, applicationName, onStart, onReconfigure, onStop) {
				if(arguments.length === 1 && arguments[0].objId && arguments[0].objType && arguments[0].objType === "VidyoVirtualWindowShare"){
					...
					if(response == null)
						throw new Error('No Response from VidyoClient');
					VCUtils.jQuery.extend(this, response.VidyoVirtualWindowShare);
					objects[this.objId] = this;

				}

				this.Destruct = function() {
					GetRequest("VidyoVirtualWindowShareDestruct?" + VCUtils.jQuery.param({ obj: this.objId }), function(){}, function(){});
					delete objects[this.objId];
				}
				...
				this.GetStats = function(stats) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('stats')){
							var params = VCUtils.jQuery.param({windowShare: this.objId, stats: JSON.stringify(arguments[0].stats)});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['stats'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
						var params = VCUtils.jQuery.param({windowShare: this.objId, stats: JSON.stringify(arguments[0])});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
						...
						GetRequest("VidyoVirtualWindowShareGetStats?" + params, OnComplete, OnError);
					});
				}
				...
				this.GetUserData = function() {
					...
					return new Promise(function(resolve, reject){
						...
						GetRequest("VidyoVirtualWindowShareGetUserData?" + params, OnComplete, OnError);
					});
				}
				...
				this.OnFrame = function(videoFrame, mediaFormat) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('videoFrame') && arguments[0].hasOwnProperty('mediaFormat')){
							var params = VCUtils.jQuery.param({w: this.objId, videoFrame: (arguments[0].videoFrame ? arguments[0].videoFrame.objId : 0), mediaFormat: arguments[0].mediaFormat});
						} else {
						...
						var params = VCUtils.jQuery.param({w: this.objId, videoFrame: (arguments[0] ? arguments[0].objId : 0), mediaFormat: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
			...
			this.CreateVidyoApplication = function(endpoint) {
				...
				if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
					if(arguments[0].hasOwnProperty('endpoint')){
						var params = VCUtils.jQuery.param({application: this.objId, endpoint: (arguments[0].endpoint ? arguments[0].endpoint.objId : 0)});
					} else {
						return Promise.reject(new MissingArgumentException('Missing Parameters', ['endpoint'], Object.keys(arguments[0])).error);
					}
				} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
					var params = VCUtils.jQuery.param({application: this.objId, endpoint: (arguments[0] ? arguments[0].objId : 0)});
				} else {
					return Promise.reject(new Error('Invalid Parameters'));
				}
			...
			this.VidyoApplication = function(endpoint) {
				if(arguments.length === 1 && arguments[0].objId && arguments[0].objType && arguments[0].objType === "VidyoApplication"){
					...
					if(response == null)
						throw new Error('No Response from VidyoClient');
					VCUtils.jQuery.extend(this, response.VidyoApplication);
					objects[this.objId] = this;

				}

				this.Destruct = function() {
					GetRequest("VidyoApplicationDestruct?" + VCUtils.jQuery.param({ obj: this.objId }), function(){}, function(){});
					delete objects[this.objId];
				}
				...
				this.RegisterUpdaterEventListener = function(onDownloadCompleted, onDownloadFailed) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('onDownloadCompleted') && arguments[0].hasOwnProperty('onDownloadFailed')){
							...
							var params = VCUtils.jQuery.param({app: this.objId});
						} else {
				...
				this.SetWebProxyCredentials = function(webProxyUserName, webProxyPassword) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('webProxyUserName') && arguments[0].hasOwnProperty('webProxyPassword')){
							var params = VCUtils.jQuery.param({app: this.objId, webProxyUserName: arguments[0].webProxyUserName, webProxyPassword: arguments[0].webProxyPassword});
						} else {
						...
						var params = VCUtils.jQuery.param({app: this.objId, webProxyUserName: arguments[0], webProxyPassword: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.StartUpdateService = function(currentVersion, workingDirectory, server, caFilePath, webProxyUsername, webProxyPassword) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('currentVersion') && arguments[0].hasOwnProperty('workingDirectory') && arguments[0].hasOwnProperty('server') && arguments[0].hasOwnProperty('caFilePath') && arguments[0].hasOwnProperty('webProxyUsername') && arguments[0].hasOwnProperty('webProxyPassword')){
							var params = VCUtils.jQuery.param({app: this.objId, currentVersion: arguments[0].currentVersion, workingDirectory: arguments[0].workingDirectory, server: arguments[0].server, caFilePath: arguments[0].caFilePath, webProxyUsername: arguments[0].webProxyUsername, webProxyPassword: arguments[0].webProxyPassword});
						} else {
						...
						var params = VCUtils.jQuery.param({app: this.objId, currentVersion: arguments[0], workingDirectory: arguments[1], server: arguments[2], caFilePath: arguments[3], webProxyUsername: arguments[4], webProxyPassword: arguments[5]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
			...
			this.VidyoEndpoint = function(viewId, viewStyle, remoteParticipants, consoleLogFilter, logFileFilter, logFileName) {
				...
				this.AppLog = function(logLevel, logMsg) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('logLevel') && arguments[0].hasOwnProperty('logMsg')){
							var params = VCUtils.jQuery.param({e: this.objId, logLevel: arguments[0].logLevel, logMsg: arguments[0].logMsg});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['logLevel', 'logMsg'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 2 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "string")){
						var params = VCUtils.jQuery.param({e: this.objId, logLevel: arguments[0], logMsg: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.AssignViewToLocalMonitor = function(viewId, localMonitor, displayCropped, allowZoom) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('localMonitor') && arguments[0].hasOwnProperty('displayCropped') && arguments[0].hasOwnProperty('allowZoom')){
							arguments[0].viewId = UpdateViewOnDOM({uiEvent:"AssignViewToLocalMonitor", viewId:arguments[0].viewId, localMonitor:arguments[0].localMonitor, displayCropped:arguments[0].displayCropped, allowZoom:arguments[0].allowZoom});
							var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0].viewId, localMonitor: (arguments[0].localMonitor ? arguments[0].localMonitor.objId : 0), displayCropped: arguments[0].displayCropped, allowZoom: arguments[0].allowZoom});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['viewId', 'localMonitor', 'displayCropped', 'allowZoom'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 4 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "object") && (typeof(arguments[2]) === "boolean") && (typeof(arguments[3]) === "boolean")){
						arguments[0] = UpdateViewOnDOM({uiEvent:"AssignViewToLocalMonitor", viewId:viewId, localMonitor:localMonitor, displayCropped:displayCropped, allowZoom:allowZoom});
						var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0], localMonitor: (arguments[1] ? arguments[1].objId : 0), displayCropped: arguments[2], allowZoom: arguments[3]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.AssignViewToLocalWindowShare = function(viewId, localWindowShare, displayCropped, allowZoom) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('viewId') && arguments[0].hasOwnProperty('localWindowShare') && arguments[0].hasOwnProperty('displayCropped') && arguments[0].hasOwnProperty('allowZoom')){
							arguments[0].viewId = UpdateViewOnDOM({uiEvent:"AssignViewToLocalWindowShare", viewId:arguments[0].viewId, localWindowShare:arguments[0].localWindowShare, displayCropped:arguments[0].displayCropped, allowZoom:arguments[0].allowZoom});
							var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0].viewId, localWindowShare: (arguments[0].localWindowShare ? arguments[0].localWindowShare.objId : 0), displayCropped: arguments[0].displayCropped, allowZoom: arguments[0].allowZoom});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['viewId', 'localWindowShare', 'displayCropped', 'allowZoom'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 4 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "object") && (typeof(arguments[2]) === "boolean") && (typeof(arguments[3]) === "boolean")){
						arguments[0] = UpdateViewOnDOM({uiEvent:"AssignViewToLocalWindowShare", viewId:viewId, localWindowShare:localWindowShare, displayCropped:displayCropped, allowZoom:allowZoom});
						var params = VCUtils.jQuery.param({e: this.objId, viewId: arguments[0], localWindowShare: (arguments[1] ? arguments[1].objId : 0), displayCropped: arguments[2], allowZoom: arguments[3]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.GetFileLoggerCategoryList = function(categories) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('categories')){
							var params = VCUtils.jQuery.param({e: this.objId, categories: JSON.stringify({"categories": arguments[0].categories})});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['categories'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
						var params = VCUtils.jQuery.param({e: this.objId, categories: JSON.stringify({"categories": arguments[0]})});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
						function OnComplete(response) {
							if(categories&& response.data.categories)
								VCUtils.jQuery.extend(categories, response.data.categories);
							resolve(response.data);
						}
						function OnError(response) {
							reject(Error(response));
				...
				this.GetProductInfo = function(productInfo, supportedFeature) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('productInfo') && arguments[0].hasOwnProperty('supportedFeature')){
							var params = VCUtils.jQuery.param({e: this.objId, productInfo: JSON.stringify({"productInfo": arguments[0].productInfo}), supportedFeature: JSON.stringify({"supportedFeature": arguments[0].supportedFeature})});
						} else {
						...
						var params = VCUtils.jQuery.param({e: this.objId, productInfo: JSON.stringify({"productInfo": arguments[0]}), supportedFeature: JSON.stringify({"supportedFeature": arguments[1]})});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
						function OnComplete(response) {
							if(productInfo&& response.data.productInfo)
								VCUtils.jQuery.extend(productInfo, response.data.productInfo);
							if(supportedFeature&& response.data.supportedFeature)
								VCUtils.jQuery.extend(supportedFeature, response.data.supportedFeature);
							resolve(response.data);
						}
						function OnError(response) {
							reject(Error(response));
				...
				this.SelectVirtualWindowShare = function(virtualWindowShare) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('virtualWindowShare')){
							var params = VCUtils.jQuery.param({e: this.objId, virtualWindowShare: (arguments[0].virtualWindowShare ? arguments[0].virtualWindowShare.objId : 0)});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['virtualWindowShare'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
						var params = VCUtils.jQuery.param({e: this.objId, virtualWindowShare: (arguments[0] ? arguments[0].objId : 0)});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetConsoleLoggerUTC = function(utc) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('utc')){
							var params = VCUtils.jQuery.param({e: this.objId, utc: arguments[0].utc});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['utc'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "boolean")){
						var params = VCUtils.jQuery.param({e: this.objId, utc: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetFileLoggerRotationParameters = function(maxSize, wrapPeriod, wrapCount) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('maxSize') && arguments[0].hasOwnProperty('wrapPeriod') && arguments[0].hasOwnProperty('wrapCount')){
							var params = VCUtils.jQuery.param({e: this.objId, maxSize: arguments[0].maxSize, wrapPeriod: arguments[0].wrapPeriod, wrapCount: arguments[0].wrapCount});
						} else {
						...
						var params = VCUtils.jQuery.param({e: this.objId, maxSize: arguments[0], wrapPeriod: arguments[1], wrapCount: arguments[2]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.SetFontFileName = function(fontFileName) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('fontFileName')){
							var params = VCUtils.jQuery.param({e: this.objId, fontFileName: arguments[0].fontFileName});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['fontFileName'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "string")){
						var params = VCUtils.jQuery.param({e: this.objId, fontFileName: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.ValidateLicenseKey = function(licenseKey, userName) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('licenseKey') && arguments[0].hasOwnProperty('userName')){
							var params = VCUtils.jQuery.param({e: this.objId, licenseKey: arguments[0].licenseKey, userName: arguments[0].userName});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['licenseKey', 'userName'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 2 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "string")){
						var params = VCUtils.jQuery.param({e: this.objId, licenseKey: arguments[0], userName: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
			...
			this.VidyoRoom = function(){
				...
				this.AddVirtualWindowShare = function(virtualWindowShare, removeOthers) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('virtualWindowShare') && arguments[0].hasOwnProperty('removeOthers')){
							var params = VCUtils.jQuery.param({r: this.objId, virtualWindowShare: (arguments[0].virtualWindowShare ? arguments[0].virtualWindowShare.objId : 0), removeOthers: arguments[0].removeOthers});
						} else {
						...
						var params = VCUtils.jQuery.param({r: this.objId, virtualWindowShare: (arguments[0] ? arguments[0].objId : 0), removeOthers: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.BootAllParticipants = function(reason) {
					var args = [].slice.apply(arguments);
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('reason')){
							var params = VCUtils.jQuery.param({r: this.objId, reason: arguments[0].reason});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['reason'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "string")){
						var params = VCUtils.jQuery.param({r: this.objId, reason: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.BootParticipant = function(userId, reason) {
					var args = [].slice.apply(arguments);
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('userId') && arguments[0].hasOwnProperty('reason')){
							var params = VCUtils.jQuery.param({r: this.objId, userId: arguments[0].userId, reason: arguments[0].reason});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['userId', 'reason'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 2 && (typeof(arguments[0]) === "string") && (typeof(arguments[1]) === "string")){
						var params = VCUtils.jQuery.param({r: this.objId, userId: arguments[0], reason: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.CancelInvite = function(inviteeId) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('inviteeId')){
							var params = VCUtils.jQuery.param({r: this.objId, inviteeId: arguments[0].inviteeId});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['inviteeId'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "string")){
						var params = VCUtils.jQuery.param({r: this.objId, inviteeId: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.Enter = function(password, onEntered, onExited) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('password') && arguments[0].hasOwnProperty('onEntered') && arguments[0].hasOwnProperty('onExited')){
							...
							var params = VCUtils.jQuery.param({r: this.objId, password: arguments[0].password});
						} else {
						...
						var params = VCUtils.jQuery.param({r: this.objId, password: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.RemoveVirtualWindowShare = function(virtualWindowShare) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('virtualWindowShare')){
							var params = VCUtils.jQuery.param({r: this.objId, virtualWindowShare: (arguments[0].virtualWindowShare ? arguments[0].virtualWindowShare.objId : 0)});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['virtualWindowShare'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "object")){
						var params = VCUtils.jQuery.param({r: this.objId, virtualWindowShare: (arguments[0] ? arguments[0].objId : 0)});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.ReportLocalParticipantOnJoined = function(reportLocalParticipant) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('reportLocalParticipant')){
							var params = VCUtils.jQuery.param({r: this.objId, reportLocalParticipant: arguments[0].reportLocalParticipant});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['reportLocalParticipant'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "boolean")){
						var params = VCUtils.jQuery.param({r: this.objId, reportLocalParticipant: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.RequestRoleChange = function(newRole, auth, onRequestRoleChangeResult, requestId) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('newRole') && arguments[0].hasOwnProperty('auth') && arguments[0].hasOwnProperty('onRequestRoleChangeResult') && arguments[0].hasOwnProperty('requestId')){
							...
							var params = VCUtils.jQuery.param({room: this.objId, newRole: arguments[0].newRole, auth: JSON.stringify(arguments[0].auth), requestId: arguments[0].requestId});
						} else {
						...
						var params = VCUtils.jQuery.param({room: this.objId, newRole: arguments[0], auth: JSON.stringify(arguments[1]), requestId: arguments[3]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.ResizeStatisticsDialog = function(width, height) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('width') && arguments[0].hasOwnProperty('height')){
							var params = VCUtils.jQuery.param({r: this.objId, width: arguments[0].width, height: arguments[0].height});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['width', 'height'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 2 && (typeof(arguments[0]) === "number") && (typeof(arguments[1]) === "number")){
						var params = VCUtils.jQuery.param({r: this.objId, width: arguments[0], height: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.CreateRoomFromKey = function(roomKey, createToken, onRoomCreated) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('roomKey') && arguments[0].hasOwnProperty('createToken') && arguments[0].hasOwnProperty('onRoomCreated')){
							this.VidyoUserOnRoomCreated = arguments[0].onRoomCreated;
							var params = VCUtils.jQuery.param({u: this.objId, roomKey: arguments[0].roomKey, createToken: arguments[0].createToken});
						} else {
						...
						this.VidyoUserOnRoomCreated = onRoomCreated;
						var params = VCUtils.jQuery.param({u: this.objId, roomKey: arguments[0], createToken: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.CreateScheduledRoom = function(schedule, createToken, onRoomCreated) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('schedule') && arguments[0].hasOwnProperty('createToken') && arguments[0].hasOwnProperty('onRoomCreated')){
							this.VidyoUserOnRoomCreated = arguments[0].onRoomCreated;
							var params = VCUtils.jQuery.param({u: this.objId, schedule: JSON.stringify(arguments[0].schedule), createToken: arguments[0].createToken});
						} else {
						...
						this.VidyoUserOnRoomCreated = onRoomCreated;
						var params = VCUtils.jQuery.param({u: this.objId, schedule: JSON.stringify(arguments[0]), createToken: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.CreateTestCallRoom = function(createToken, onRoomCreated) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('createToken') && arguments[0].hasOwnProperty('onRoomCreated')){
							this.VidyoUserOnRoomCreated = arguments[0].onRoomCreated;
							var params = VCUtils.jQuery.param({u: this.objId, createToken: arguments[0].createToken});
						} else {
						...
						this.VidyoUserOnRoomCreated = onRoomCreated;
						var params = VCUtils.jQuery.param({u: this.objId, createToken: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.GetAuthTypes = function(host, port, serviceType, onAuthTypes, onWebProxyCredentialsRequest) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('host') && arguments[0].hasOwnProperty('port') && arguments[0].hasOwnProperty('serviceType') && arguments[0].hasOwnProperty('onAuthTypes') && arguments[0].hasOwnProperty('onWebProxyCredentialsRequest')){
							...
							var params = VCUtils.jQuery.param({u: this.objId, host: arguments[0].host, port: arguments[0].port, serviceType: arguments[0].serviceType});
						} else {
						...
						var params = VCUtils.jQuery.param({u: this.objId, host: arguments[0], port: arguments[1], serviceType: arguments[2]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.InvalidateTokenOnLogout = function(invalidate) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('invalidate')){
							var params = VCUtils.jQuery.param({user: this.objId, invalidate: arguments[0].invalidate});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['invalidate'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 1 && (typeof(arguments[0]) === "boolean")){
						var params = VCUtils.jQuery.param({user: this.objId, invalidate: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.LoginAsGuest = function(displayName, roomKey, host, port, serviceType, onLoginComplete, onLoggedOut, onConnectionStatusChanged, onTokenReceived, onWebProxyCredentialsRequest) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('displayName') && arguments[0].hasOwnProperty('roomKey') && arguments[0].hasOwnProperty('host') && arguments[0].hasOwnProperty('port') && arguments[0].hasOwnProperty('serviceType') && arguments[0].hasOwnProperty('onLoginComplete') && arguments[0].hasOwnProperty('onLoggedOut') && arguments[0].hasOwnProperty('onConnectionStatusChanged') && arguments[0].hasOwnProperty('onTokenReceived') && arguments[0].hasOwnProperty('onWebProxyCredentialsRequest')){
							...
							this.VidyoUserOnTokenReceived = arguments[0].onTokenReceived;
							this.VidyoUserOnWebProxyCredentialsRequest = arguments[0].onWebProxyCredentialsRequest;
							var params = VCUtils.jQuery.param({u: this.objId, displayName: arguments[0].displayName, roomKey: arguments[0].roomKey, host: arguments[0].host, port: arguments[0].port, serviceType: arguments[0].serviceType});
						} else {
						...
						this.VidyoUserOnTokenReceived = onTokenReceived;
						this.VidyoUserOnWebProxyCredentialsRequest = onWebProxyCredentialsRequest;
						var params = VCUtils.jQuery.param({u: this.objId, displayName: arguments[0], roomKey: arguments[1], host: arguments[2], port: arguments[3], serviceType: arguments[4]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.LoginWithCAC = function(certificate, host, port, serviceType, onLoginComplete, onLoggedOut, onConnectionStatusChanged, onTokenReceived, onWebProxyCredentialsRequest) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('certificate') && arguments[0].hasOwnProperty('host') && arguments[0].hasOwnProperty('port') && arguments[0].hasOwnProperty('serviceType') && arguments[0].hasOwnProperty('onLoginComplete') && arguments[0].hasOwnProperty('onLoggedOut') && arguments[0].hasOwnProperty('onConnectionStatusChanged') && arguments[0].hasOwnProperty('onTokenReceived') && arguments[0].hasOwnProperty('onWebProxyCredentialsRequest')){
							...
							this.VidyoUserOnTokenReceived = arguments[0].onTokenReceived;
							this.VidyoUserOnWebProxyCredentialsRequest = arguments[0].onWebProxyCredentialsRequest;
							var params = VCUtils.jQuery.param({u: this.objId, certificate: arguments[0].certificate, host: arguments[0].host, port: arguments[0].port, serviceType: arguments[0].serviceType});
						} else {
						...
						this.VidyoUserOnTokenReceived = onTokenReceived;
						this.VidyoUserOnWebProxyCredentialsRequest = onWebProxyCredentialsRequest;
						var params = VCUtils.jQuery.param({u: this.objId, certificate: arguments[0], host: arguments[1], port: arguments[2], serviceType: arguments[3]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.LoginWithSAML = function(key, host, port, serviceType, onLoginComplete, onLoggedOut, onConnectionStatusChanged, onTokenReceived, onWebProxyCredentialsRequest) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('key') && arguments[0].hasOwnProperty('host') && arguments[0].hasOwnProperty('port') && arguments[0].hasOwnProperty('serviceType') && arguments[0].hasOwnProperty('onLoginComplete') && arguments[0].hasOwnProperty('onLoggedOut') && arguments[0].hasOwnProperty('onConnectionStatusChanged') && arguments[0].hasOwnProperty('onTokenReceived') && arguments[0].hasOwnProperty('onWebProxyCredentialsRequest')){
							...
							this.VidyoUserOnTokenReceived = arguments[0].onTokenReceived;
							this.VidyoUserOnWebProxyCredentialsRequest = arguments[0].onWebProxyCredentialsRequest;
							var params = VCUtils.jQuery.param({u: this.objId, key: arguments[0].key, host: arguments[0].host, port: arguments[0].port, serviceType: arguments[0].serviceType});
						} else {
						...
						this.VidyoUserOnTokenReceived = onTokenReceived;
						this.VidyoUserOnWebProxyCredentialsRequest = onWebProxyCredentialsRequest;
						var params = VCUtils.jQuery.param({u: this.objId, key: arguments[0], host: arguments[1], port: arguments[2], serviceType: arguments[3]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.PauseUpdateNotification = function(pauseUpdateNotification) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('pauseUpdateNotification')){
							var params = VCUtils.jQuery.param({u: this.objId, pauseUpdateNotification: arguments[0].pauseUpdateNotification});
						} else {
						...
						var params = VCUtils.jQuery.param({u: this.objId, pauseUpdateNotification: arguments[0]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
				...
				this.GetAttendees = function(index, pageSize) {
					...
					if(arguments.length === 1 && (typeof(arguments[0]) === "object") && !arguments[0].objId ){
						if(arguments[0].hasOwnProperty('index') && arguments[0].hasOwnProperty('pageSize')){
							var params = VCUtils.jQuery.param({m: this.objId, index: arguments[0].index, pageSize: arguments[0].pageSize});
						} else {
							return Promise.reject(new MissingArgumentException('Missing Parameters', ['index', 'pageSize'], Object.keys(arguments[0])).error);
						}
					} else if (arguments.length === 2 && (typeof(arguments[0]) === "number") && (typeof(arguments[1]) === "number")){
						var params = VCUtils.jQuery.param({m: this.objId, index: arguments[0], pageSize: arguments[1]});
					} else {
						return Promise.reject(new Error('Invalid Parameters'));
					}
					return new Promise(function(resolve, reject){
			...
			var callbacks = {
				...
				VidyoCalendarManagerFeedbackCalendarDestroyed: function(response) {
					...
					try {
						...
						return GetRequest("VidyoCalendarManagerFeedbackCalendarDestroyedComplete?" + VCUtils.jQuery.param({ f: response.VidyoCalendarManagerFeedback ? response.VidyoCalendarManagerFeedback.objId : 0, cm: response.VidyoCalendarManager ? response.VidyoCalendarManager.objId : 0 }), function(){}, function(){});
					}
				},
				...
				VidyoCalendarFeedbackGetCapabilitiesResult: function(response) {
					...
					try {
						...
						return GetRequest("VidyoCalendarFeedbackGetCapabilitiesResultComplete?" + VCUtils.jQuery.param({ f: response.VidyoCalendarFeedback ? response.VidyoCalendarFeedback.objId : 0, c: response.VidyoCalendar ? response.VidyoCalendar.objId : 0 }), function(){}, function(){});
					}
				},
				...
				VidyoCalendarFeedbackMeetingCreatedById: function(response) {
					...
					try {
						...
						return GetRequest("VidyoCalendarFeedbackMeetingCreatedByIdComplete?" + VCUtils.jQuery.param({ f: response.VidyoCalendarFeedback ? response.VidyoCalendarFeedback.objId : 0, c: response.VidyoCalendar ? response.VidyoCalendar.objId : 0, m: response.VidyoMeeting ? response.VidyoMeeting.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoCalendarFeedbackMeetingCreatedByService: function(response) {
					...
					try {
						...
						return GetRequest("VidyoCalendarFeedbackMeetingCreatedByServiceComplete?" + VCUtils.jQuery.param({ f: response.VidyoCalendarFeedback ? response.VidyoCalendarFeedback.objId : 0, c: response.VidyoCalendar ? response.VidyoCalendar.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoCalendarFeedbackMeetingReminder: function(response) {
					...
					try {
						...
						return GetRequest("VidyoCalendarFeedbackMeetingReminderComplete?" + VCUtils.jQuery.param({ f: response.VidyoCalendarFeedback ? response.VidyoCalendarFeedback.objId : 0, c: response.VidyoCalendar ? response.VidyoCalendar.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoCalendarFeedbackMeetingRemovedByService: function(response) {
					...
					try {
						...
						return GetRequest("VidyoCalendarFeedbackMeetingRemovedByServiceComplete?" + VCUtils.jQuery.param({ f: response.VidyoCalendarFeedback ? response.VidyoCalendarFeedback.objId : 0, c: response.VidyoCalendar ? response.VidyoCalendar.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoCalendarFeedbackMeetingUpdatedByService: function(response) {
					...
					try {
						...
						return GetRequest("VidyoCalendarFeedbackMeetingUpdatedByServiceComplete?" + VCUtils.jQuery.param({ f: response.VidyoCalendarFeedback ? response.VidyoCalendarFeedback.objId : 0, c: response.VidyoCalendar ? response.VidyoCalendar.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoCalendarFeedbackSeriesUpdate: function(response) {
					...
					try {
						...
						return GetRequest("VidyoCalendarFeedbackSeriesUpdateComplete?" + VCUtils.jQuery.param({ f: response.VidyoCalendarFeedback ? response.VidyoCalendarFeedback.objId : 0, c: response.VidyoCalendar ? response.VidyoCalendar.objId : 0 }), function(){}, function(){});
					}
				},
				...
				VidyoLocalRendererOnPipLocationChanged: function(response) {
					...
					try {
						...
						return GetRequest("VidyoLocalRendererOnPipLocationChangedComplete?" + VCUtils.jQuery.param({ renderer: response.VidyoLocalRenderer ? response.VidyoLocalRenderer.objId : 0 }), function(){}, function(){});
					}
				},
				...
				VidyoVirtualWindowShareReconfigureCallback: function(response) {
					...
					try {
						...
						return GetRequest("VidyoVirtualWindowShareReconfigureCallbackComplete?" + VCUtils.jQuery.param({ w: response.VidyoVirtualWindowShare ? response.VidyoVirtualWindowShare.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoVirtualWindowShareStartCallback: function(response) {
					...
					try {
						...
						return GetRequest("VidyoVirtualWindowShareStartCallbackComplete?" + VCUtils.jQuery.param({ w: response.VidyoVirtualWindowShare ? response.VidyoVirtualWindowShare.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoVirtualWindowShareStopCallback: function(response) {
					...
					try {
						...
						return GetRequest("VidyoVirtualWindowShareStopCallbackComplete?" + VCUtils.jQuery.param({ c: response.VidyoVirtualWindowShare ? response.VidyoVirtualWindowShare.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoApplicationDownloadCompletedCallback: function(response) {
					...
					try {
						...
						return GetRequest("VidyoApplicationDownloadCompletedCallbackComplete?" + VCUtils.jQuery.param({ app: response.VidyoApplication ? response.VidyoApplication.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoApplicationDownloadFailedCallback: function(response) {
					...
					try {
						...
						return GetRequest("VidyoApplicationDownloadFailedCallbackComplete?" + VCUtils.jQuery.param({ app: response.VidyoApplication ? response.VidyoApplication.objId : 0 }), function(){}, function(){});
					}
				},
				...
				VidyoRoomOnIncomingEntered: function(response) {
					...
					try {
						...
						return GetRequest("VidyoRoomOnIncomingEnteredComplete?" + VCUtils.jQuery.param({ room: response.VidyoRoom ? response.VidyoRoom.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoRoomOnIncomingExited: function(response) {
					...
					try {
						...
						return GetRequest("VidyoRoomOnIncomingExitedComplete?" + VCUtils.jQuery.param({ room: response.VidyoRoom ? response.VidyoRoom.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoRoomOnInviteResult: function(response) {
					...
					try {
						...
						return GetRequest("VidyoRoomOnInviteResultComplete?" + VCUtils.jQuery.param({ room: response.VidyoRoom ? response.VidyoRoom.objId : 0 }), function(){}, function(){});
					}
				},
				...
				VidyoRoomOnMediaRouteAcquireFailed: function(response) {
					...
					try {
						...
						return GetRequest("VidyoRoomOnMediaRouteAcquireFailedComplete?" + VCUtils.jQuery.param({ room: response.VidyoRoom ? response.VidyoRoom.objId : 0 }), function(){}, function(){});
					}
				},
				...
				VidyoRoomOnPipLocationChanged: function(response) {
					...
					try {
						...
						return GetRequest("VidyoRoomOnPipLocationChangedComplete?" + VCUtils.jQuery.param({ room: response.VidyoRoom ? response.VidyoRoom.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoRoomOnRequestRoleChangeResult: function(response) {
					...
					try {
						...
						return GetRequest("VidyoRoomOnRequestRoleChangeResultComplete?" + VCUtils.jQuery.param({ room: response.VidyoRoom ? response.VidyoRoom.objId : 0 }), function(){}, function(){});
					}
				},
				...
				VidyoRoomOnUnprocessedAudioStarted: function(response) {
					...
					try {
						...
						return GetRequest("VidyoRoomOnUnprocessedAudioStartedComplete?" + VCUtils.jQuery.param({ room: response.VidyoRoom ? response.VidyoRoom.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoRoomOnUnprocessedAudioSupportChanged: function(response) {
					...
					try {
						...
						return GetRequest("VidyoRoomOnUnprocessedAudioSupportChangedComplete?" + VCUtils.jQuery.param({ room: response.VidyoRoom ? response.VidyoRoom.objId : 0 }), function(){}, function(){});
					}
				},
				...
				VidyoUserOnAuthTypes: function(response) {
					...
					try {
						...
						return GetRequest("VidyoUserOnAuthTypesComplete?" + VCUtils.jQuery.param({ u: response.VidyoUser ? response.VidyoUser.objId : 0 }), function(){}, function(){});
					}
				},
				VidyoUserOnAuthTypesWebProxyCredentialsRequest: function(response) {
					...
					try {
						...
						return GetRequest("VidyoUserOnAuthTypesWebProxyCredentialsRequestComplete?" + VCUtils.jQuery.param({ u: response.VidyoUser ? response.VidyoUser.objId : 0 }), function(){}, function(){});
					}
				},
				...
				VidyoUserOnPasswordResetUrl: function(response) {
					...
					try {
						...
						return GetRequest("VidyoUserOnPasswordResetUrlComplete?" + VCUtils.jQuery.param({ u: response.VidyoUser ? response.VidyoUser.objId : 0 }), function(){}, function(){});
					}
				},
				...
				VidyoUserOnRoomInviteCancelled: function(response) {
					...
					try {
						...
						return GetRequest("VidyoUserOnRoomInviteCancelledComplete?" + VCUtils.jQuery.param({ u: response.VidyoUser ? response.VidyoUser.objId : 0 }), function(){}, function(){});
					}
				},
				...
				VidyoMeetingFeedbackGetMeetingAttendeeResults: function(response) {
					...
					try {
						...
						return GetRequest("VidyoMeetingFeedbackGetMeetingAttendeeResultsComplete?" + VCUtils.jQuery.param({ f: response.VidyoMeetingFeedback ? response.VidyoMeetingFeedback.objId : 0, meeting: response.VidyoMeeting ? response.VidyoMeeting.objId : 0 }), function(){}, function(){});
					}
				},
			};
